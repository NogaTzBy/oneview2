...
export function EcommerceDashboard({ isSuperAdmin }: EcommerceDashboardProps) {
        ...
        <div className="min-h-screen bg-background-light">
            ...
            <main className="pt-24 pb-12 px-6 max-w-7xl mx-auto">
                ...
                <div className="mb-8 flex justify-between items-end">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Resumen E-commerce</h1>

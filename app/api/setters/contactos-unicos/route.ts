...
/**
 * GET /api/setters/contactos-unicos
 *
 * Devuelve el conteo de contactos únicos (ai_message_sent) del proyecto FA Interiores.
 *
 * Query params:
...
export async function GET(request: NextRequest) {
    try {
        ...
        // Fetch ai_message_sent events for the date range
        ...
        if (error) {
            console.error('Error fetching contactos únicos:', error);
            return NextResponse.json(

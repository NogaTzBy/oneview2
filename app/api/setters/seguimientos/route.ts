...
/**
 * GET /api/setters/seguimientos
 *
 * Devuelve el conteo de seguimientos (second_follow_up) del proyecto FA Interiores.
 *
 * Query params:
...
export async function GET(request: NextRequest) {
    try {
        ...
        // Fetch second_follow_up events for the date range
        ...
        const { data: events, error } = await supabase
            ...
            .eq('event_type', 'second_follow_up')
